...
public class CocheTree implements Dao<Coche> {
	private TreeMap<Long, Coche> coches = new TreeMap<>();

	// SINGLETON
	private final static CocheTree INSTANCIA = new CocheTree();
	...
	public static CocheTree getInstancia() { return INSTANCIA; }
	// FIN SINGLETON
