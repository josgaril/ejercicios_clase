CREATE DATABASE  IF NOT EXISTS `mf0966_3` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_bin */;
USE `mf0966_3`;
...
INSERT INTO `resena` VALUES (1,' Curso perfecto',1,1),(2,'No me ha gustado nada',1,2),(3,'Me encantó ',2,1),(5,'Excelente',1,4),(6,'Muy mal',4,2),(7,'Bien',3,1),(8,'Sin mas',2,2),(9,'Recomendable',4,4),(12,'Decente',2,1),(13,'Bastante bien, la verdad',2,4),(15,'No repetiría nunca',3,2),(18,'Para repetir',2,2),(19,'Encantadisimo con el curso',2,4);
...
-- Dump completed on 2020-03-12 14:35:49
