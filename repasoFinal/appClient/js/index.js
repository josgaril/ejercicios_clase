...
function listener(){
    ...
    /* Filtro nombre disponible */
    let inputNombreBuscar = document.getElementById('inputNombre');
    inputNombreBuscar.addEventListener('keyup', filtroNombre);
}

function filtroNombre(){
    console.info('filtrando por nombre');
    let inputNombreBuscar = document.getElementById('inputNombre');
    let sNombre = document.getElementById('sNombre');
    
    const rol='alumno';
    const url = endpoint + 'personas/?rol=' + rol + '&nombre='+ inputNombreBuscar.value;
    if( personaSeleccionada.nombre != inputNombreBuscar.value){
