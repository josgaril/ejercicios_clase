CREATE DATABASE  IF NOT EXISTS `empadronamientooo` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `personas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `dni` char(9) COLLATE utf8_spanish2_ci NOT NULL,
  `nombre` varchar(200) COLLATE utf8_spanish2_ci DEFAULT NULL,
...
INSERT INTO `situacion` VALUES (1,1,1,1),(1,2,0,1),(1,3,0,1),(1,4,0,1),(2,2,1,1),(3,1,1,0),(4,3,0,1),(4,4,1,1),(5,4,1,0),(6,5,1,1),(7,6,1,0);
...
-- Dump completed on 2020-02-04  0:01:43
