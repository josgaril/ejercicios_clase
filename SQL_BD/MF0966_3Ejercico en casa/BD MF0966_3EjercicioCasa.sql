CREATE DATABASE  IF NOT EXISTS `mf0966_3ejerciciocasa` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mf0966_3ejerciciocasa`;
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: mf0966_3ejerciciocasa
-- ------------------------------------------------------
...
CREATE TABLE `resena` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `fk_resena_alumno1_idx` (`alumno_codigo`) /*!80000 INVISIBLE */,
...
--
-- Dumping events for database 'mf0966_3ejerciciocasa'
--

--
-- Dumping routines for database 'mf0966_3ejerciciocasa'
--
/*!50003 DROP PROCEDURE IF EXISTS `alumnoCreate` */;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8 COLLATE utf8_bin ;
...
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci ;
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `resenaCreate` */;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8 COLLATE utf8_bin ;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `resenaCreate`(IN palumno_codigo INT, IN pcurso_codigo INT, IN pcomentario TEXT, OUT pcodigo INT)
BEGIN
	INSERT INTO resena (alumno_codigo, curso_codigo, comentario) VALUES(palumno_codigo,pcurso_codigo,pcomentario);
    SET pcodigo = LAST_INSERT_ID();
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `resenaDelete` */;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8 COLLATE utf8_bin ;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `resenaDelete`(IN pcodigo INT)
BEGIN
	DELETE FROM resena WHERE codigo = pcodigo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `resenagetAll` */;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8 COLLATE utf8_bin ;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `resenagetAll`()
BEGIN
	SELECT codigo, alumno_codigo, curso_codigo, comentario  FROM resena;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `resenagetByCodigo` */;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8 COLLATE utf8_bin ;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `resenagetByCodigo`(IN _codigo INT)
BEGIN
	SELECT codigo, alumno_codigo, curso_codigo, comentario  FROM resena WHERE codigo=_codigo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET collation_connection  = @saved_col_connection */ ;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci ;
/*!50003 DROP PROCEDURE IF EXISTS `resenaUpdate` */;
ALTER DATABASE `mf0966_3ejerciciocasa` CHARACTER SET utf8 COLLATE utf8_bin ;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `resenaUpdate`(IN pcodigo INT, IN palumno_codigo INT, IN pcurso_codigo INT, IN pcomentario TEXT)
BEGIN
	UPDATE resena SET alumno_codigo=LOWER(palumno_codigo), curso_codigo= LOWER(pcurso_codigo), comentario = LOWER(pcomentario) WHERE codigo = pcodigo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
