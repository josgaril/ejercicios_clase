CREATE DATABASE  IF NOT EXISTS `alojamiento_rural` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci */;
USE `alojamiento_rural`;
-- MySQL dump 10.13  Distrib 8.0.12, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: alojamiento_rural
-- ------------------------------------------------------
...
CREATE TABLE `actividades` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='		';
...
CREATE TABLE `trabajadores` (
  ...
  `NIF` varchar(9) COLLATE utf8_spanish2_ci DEFAULT NULL,
  `alojamiento_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping events for database 'alojamiento_rural'
--

--
-- Dumping routines for database 'alojamiento_rural'
--
...
-- Dump completed on 2020-02-05 14:19:36
