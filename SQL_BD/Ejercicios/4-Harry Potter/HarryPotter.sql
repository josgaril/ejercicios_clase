...
CREATE TABLE IF NOT EXISTS `Harry_Potter`.`alumnos` (
  ...
  `anno_nacimiento` SMALLINT NOT NULL,
  `casa_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Harry_Potter`.`partidos` (
  ...
  `casa1_resultado` TINYINT NOT NULL,
  `casa2_resultado` TINYINT NOT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `Harry_Potter`.`partidos_has_alumnos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Harry_Potter`.`partidos_has_alumnos` (
  `partidos_id` INT NOT NULL,
  `alumnos_id` INT NOT NULL,
  PRIMARY KEY (`partidos_id`, `alumnos_id`),
  INDEX `fk_partidos_has_alumnos_alumnos1_idx` (`alumnos_id` ASC) VISIBLE,
  INDEX `fk_partidos_has_alumnos_partidos1_idx` (`partidos_id` ASC) VISIBLE,
  CONSTRAINT `fk_partidos_has_alumnos_partidos1`
    FOREIGN KEY (`partidos_id`)
    REFERENCES `Harry_Potter`.`partidos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_partidos_has_alumnos_alumnos1`
    FOREIGN KEY (`alumnos_id`)
    REFERENCES `Harry_Potter`.`alumnos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
