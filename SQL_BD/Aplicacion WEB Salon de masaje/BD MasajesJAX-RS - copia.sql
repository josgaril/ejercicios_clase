CREATE DATABASE  IF NOT EXISTS `masajesjax-rs` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci */;
USE `masajesjax-rs`;
...
INSERT INTO `clientes` VALUES (1,'Roberto','Loyoa Gil','78963256U'),(2,'Vanesa','Romero Cuesta','74112588Y'),(6,'Rodolfo','Chiquilicuatre','78785421G'),(7,'Miguelito','Minguez Mengual','78785421N'),(8,'Minguito','Lorenzo Grijalba','72514585V'),(9,'Lara','Alvarez Serna','75856555K'),(11,'Pepe Luis','Gonzalez Ruiz','71252222A'),(12,'Ramon','Pelaez','78888888F'),(13,'s s','Casas O\'donnel','71131223F'),(39,'Javier','Ortega Perez','75421585L'),(40,'Lorenza','Martinez Pernia','75123695W'),(73,'Eufranisio','Pelaez Mendez','74411214P');
...
) ENGINE=InnoDB AUTO_INCREMENT=504 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-11  9:30:29
