...
public class EntradaSalidaDatos2 {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		// 2- Programa que lee por teclado el valor del radio de una circunferencia y calcula y muestra por pantalla la longitud y el área de la circunferencia
		System.out.print("Introduaza el radio de la circunferencia:");
