...
<div class="row">
	<form action="admin/trabajador/${op}" method="post"
		...
		<fieldset>
			<legend>${op} trabajador</legend>

			<input type="hidden" id="op" name="op" value="${op}">

			<div class="form-group row">
				<label for="idtrabajadores" class="col-sm-2 col-form-label">Id</label>
				<div class="col-sm-10">
					<input type="number" class="form-control" id="idtrabajadores" name="idtrabajadores"
						value="${trabajador.idtrabajadores}" readonly>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<div class="offset-sm-2 col-sm-10">
					...
					<a class="btn btn-success mx-2" href="admin/trabajadores" role="button">Cancelar</a>
