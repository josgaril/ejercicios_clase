...
public class Libro implements Serializable {
	...
	/* COmentamos este constructor porque creo que esta mal, formato segun lo que tenia yo puesto en el ejercicio es String
	 * public Libro(Long id, String titulo, String isbn, int paginas, boolean
	 * formato) {
	 * 
	 * }
	 */
	public Libro() { // creamos el constructor vac�o
	...
	public void setId(Long id) {
		if (id != null && id < 0) {
			throw new EntidadesException("No est�n permitidos id's negativos");
		}
	...
	public void setTitulo(String titulo) {
		if (titulo == null || titulo.trim().length() <= 3 || titulo.trim().length() >= 150) {
			throw new EntidadesException("El t�tulo debe tener entre 3 y 150 caracteres");
		}
		if (!titulo.matches(REGEX_TITULO)) {
			throw new EntidadesException("El t�tulo s�lo debe tener caracteres de letras, espacios y/o ap�strofes");
		}
		this.titulo = titulo;
	}
	...
	public void setIsbn(String isbn) {
		if (isbn == null || isbn.trim().length() == 0) {
			throw new EntidadesException("El ISBN no puede estar vac�o");
		}
		if (!isbn.matches(REGEX_ISBN)) {
			throw new EntidadesException("El ISBN tiene que estar formado por 10 n�meros");
		}
		this.isbn = isbn;
	}
	...
	public void setPaginas(int paginas) {
		if (paginas < 1) {
			throw new EntidadesException("El n�mero de p�ginas m�nimo de un libro es 1");
		}
